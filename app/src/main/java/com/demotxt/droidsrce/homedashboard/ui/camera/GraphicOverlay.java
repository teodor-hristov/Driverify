 ...
 */
package com.demotxt.droidsrce.homedashboard.ui.camera;
...
public class GraphicOverlay extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        synchronized (mLock) {
            ...
            for (Graphic graphic : mGraphics) {
                graphic.draw(canvas);
                graphic.checkIfSleepy(super.getContext(), canvas);
            }
        }
    }
    ...
    public static abstract class Graphic {
        ...
        public abstract void checkIfSleepy(Context ctx, Canvas canvas);
